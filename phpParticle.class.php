<?php
/**
 * Particle Class for interacting with the particle cloud. 
 * 
 * @project ptlogger
...
/**
 * Clase phpParticle para gestionar interaccion con la nube Particle. 
 * 
 * @project ptlogger
 * @file    phpParticle.class.php
 * @date    April, 2017
...
class phpParticle
{
    ...
    {
        return $this->_debug($debugText, $override = false);
    }
    ...
    {
        return $this->_debug_r($debugArray, $override = false);
    }
